              ...
              <DataCard
                ...
                actions={
                  <>
                    ...
                    <GhostButton onClick={() => void deleteProject(selectedBundle.project.id)}>
                      <Trash2 size={16} />
                    </GhostButton>
                  </>
                }
                ...
                {selectedBundle.steps.length ? (
                  <div className="workspace-stack">
                    {selectedBundle.steps.map((step) => (
                      <div key={step.id} className="workspace-row-card">
                        <div>
                        ...
                        <div className="workspace-inline-actions">
                          ...
                          <GhostButton onClick={() => void deleteProjectStep(step.id)}>
                            <Trash2 size={16} />
                          </GhostButton>
                        </div>
                      </div>
